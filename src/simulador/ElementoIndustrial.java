...
public class ElementoIndustrial extends ElementoUrbanoAbstracto {
	
	public static int id = 1;
	
	private final int identificador;
	
	public ElementoIndustrial(String nombre, int col, int fila) {
	...
	public EstadoAmbiental getEfectoAmbiental() {
		...
		e1.agregarParametro(new ParametroAmbiental("CO2", "ppm", 256)).
